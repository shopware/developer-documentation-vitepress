...
<div class="grid grid-cols-2 gap-5 mb-16">
  ...
  <div class="bg-white dark:bg-slate-800 shadow-md hover:bg-shopware-gray-light transition transition-all rounded-lg p-5">
    <div class="flex items-center">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="#189eff">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />
      </svg>
      <h3 class="text-2xl mt-4 ml-3 py-0 text-center dark:text-slate-300">
        Apps
      </h3>
    </div>
  ...
  <div class="bg-white dark:bg-slate-800 shadow-md hover:bg-shopware-gray-light transition transition-all rounded-lg p-5">
    <div class="flex items-center">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 20 20" fill="#189eff">
...
<div class="w-full md:max-w-screen-2xl mx-auto">
  <h1 class="text-4xl tracking-wide font-extrabold mb-10" style="background-image: url('https://www.shopware.com/media/image/24/73/97/gradient-wavey-rectangle.jpg');-webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      background-position: center;
      width: fit-content;
      background-size: cover;">Explore Resources</h1>
</div>
