                ...
                <div class="bg-white dark:bg-#111 p-10 grow xl:rounded-b-xl">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-3">
                        <div class="md:col-span-2 mb-6">
                            ...
                            <input v-model="registrationData.email" type="text" id="sandbox_email" placeholder="Email" class="text-14px border-1px rounded-md border-#d4d8dc dark:border-#040404 p-3 box-border w-full placeholder:text-#60718280 focus:border-#189eff">
                        </div>
                        <div v-bind:class="{ 'mb-8': existingAccount, 'md:col-span-2': existingAccount }">
                            ...
                            <input v-model="registrationData.password" type="password" id="sandbox_password" placeholder="Password" class="text-14px border-1px rounded-md border-#d4d8dc dark:border-#040404 p-3 box-border w-full placeholder:text-#60718280 focus:border-#189eff">
                        </div>
                        <div class="mb-4" v-if="!existingAccount">
                            ...
                            <input v-model="registrationData.passwordRepeat" type="password" id="sandbox_password_repeat" placeholder="Repeat Password" class="text-14px border-1px rounded-md border-#d4d8dc dark:border-#040404 p-3 box-border w-full placeholder:text-#60718280 focus:border-#189eff">
                        </div>
                        <div class="md:col-span-2 mb-8" v-if="!existingAccount">
                            <p class="text-#607182bb my-none">
                                ...
                                <label for="tc"> I agree to the <a href="https://shopware.com/en/privacy/" title="Privacy policy" target="_blank" class="text-shopware">privacy policy</a> and the <a href="https://shopware.com/en/gtc/" title="Terms and conditions" target="_blank" class="text-shopware">terms and conditions</a></label>
                            </p>
                        </div>
                    </div>
                    <div>
        ...
        let createSandbox = function () {
            if (registrationData.tcAccepted) {
                if (registrationData.password === registrationData.passwordRepeat) {
                    ...
                    const cloudShopData = {
                        "subDomain": registrationData.sandbox,
